#ifndef VL53L1X_H_INCLUDED
#define VL53L1X_H_INCLUDED
...
typedef struct _VL53L1X
{
    ...
    uint16_t io_timeout;
    int did_timeout; // was bool
    uint16_t timeout_start_ms;

    uint16_t fast_osc_frequency;
    uint16_t osc_calibrate_val;

    int calibrated; // was bool
...
int VL53L1X_start(VL53L1X* vl, int io_2v8); // default 1 = true
...
int VL53L1X_setDistanceMode(VL53L1X* vl, DistanceMode mode); // was returning bool
...
uint16_t VL53L1X_read(VL53L1X* vl, int blocking); // blocking, default 1 = true
uint16_t VL53L1X_readRangeContinuousMillimeters(VL53L1X* vl, int blocking); // alias of read(), default 1 = true for blocking

// check if sensor has new reading available
// assumes interrupt is active low (GPIO_HV_MUX__CTRL bit 4 is 1)
int VL53L1X_dataReady(VL53L1X* vl); // was returning bool

static const char * VL53L1X_rangeStatusToString(VL53L1X* vl, RangeStatus status);

void VL53L1X_setTimeout(VL53L1X* vl, uint16_t timeout);
uint16_t VL53L1X_getTimeout(VL53L1X* vl);
int VL53L1X_timeoutOccurred(VL53L1X* vl); // was returning obol
...
static uint32_t VL53L1X_decodeTimeout(VL53L1X* vl, uint16_t reg_val);
static uint16_t VL53L1X_encodeTimeout(VL53L1X* vl, uint32_t timeout_mclks);
static uint32_t VL53L1X_timeoutMclksToMicroseconds(VL53L1X* vl, uint32_t timeout_mclks, uint32_t macro_period_us);
static uint32_t VL53L1X_timeoutMicrosecondsToMclks(VL53L1X* vl, uint32_t timeout_us, uint32_t macro_period_us);
