...
void VL53setAddress(uint8_t new_addr)
{
  writeReg(I2C_SLAVE__DEVICE_ADDRESS, new_addr & 0x7F);
  VL53address = new_addr;
}
...
uint8_t vl53_I2cData[32] __ATTR_RAM_D2;
...
void writeReg(uint16_t reg, uint8_t value)
{
	...
	vl53_I2cData[0] = 0xFE;
	vl53_I2cData[1] = 0x41;
HAL_I2C_Master_Transmit(hi2c, LCD_I2C_ADDRESS, vl53_I2cData, 2, vl53_I2Ctimeout);
HAL_Delay(1);
//reset LCD
lcd_I2cData[0] = 0xFE;
lcd_I2cData[1] = 0x51;
